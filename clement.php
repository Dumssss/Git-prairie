...
<body>
    ...
    <main class="main">
        ...
        <section class="portfolio section" id="portfolio">
            ...
            <span class="section__subtitle">Derniers projets</span>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            <h3 class="portfolio__title">Blog Ferrari</h3>
                            <p class="portfolio__description">Un blog adress&eacute; aux fans de Ferrari, par un fan de
                                Ferrari.</p>
                            <a href="http://www.blog-ferrari.fr" class="button button--flex button--small portfolio__button">
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            <h3 class="portfolio__title">CarStats</h3>
                            <p class="portfolio__description">Application web destin&eacute;e &agrave; la visualisation
                                de
                                statistiques automobiles.</p>
                            <a href="https://github.com/Dumssss/carstats" class="button button--flex button--small portfolio__button">
                                Acc&eacute;der au d&eacute;p&ocirc;t
                                <i class="uil uil-arrow-right button__icon"></i>
                            </a>
                        </div>
                    </div>
                    <!--==================== PORTFOLIO 3 ====================-->
                    <div class="portfolio__content grid swiper-slide">
                        <img src="assets/img/novas.png" alt="" class="portfolio__img">
                        <div class="portfolio__data">
                            <h3 class="portfolio__title">Novas</h3>
                            <p class="portfolio__description">Mon premier projet web, fait avec un ami</p>
                            <a href="Site/Novas.html" class="button button--flex button--small portfolio__button">
                                Acc&eacute;der au site
                                <i class="uil uil-arrow-right button__icon"></i>
                            </a>
                        </div>
                    ...
                    <div class="portfolio__content grid swiper-slide">
                        ...
                        <div class="portfolio__data">
                            ...
                            <p class="portfolio__description">Site vitrine de mon exp&eacute;rience</p>
